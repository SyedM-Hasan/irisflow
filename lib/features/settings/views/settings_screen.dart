          ...
          child: Column(
            children: [
              ...
              _SwitchRow(
                ...
                subtitle: 'Brief pause between focus and rest',
                value: state.readyTimerEnabled,
                onChanged: (_) => notifier.toggleReadyTimer(),
              ),
              if (state.readyTimerEnabled) ...[
                const SizedBox(height: 16),
                _DurationControl(
                  label: 'Countdown Duration',
                  value: state.readyDuration,
                  unit: 'seconds',
                  onInc: notifier.incrementReadyDuration,
                  onDec: notifier.decrementReadyDuration,
                ),
              ],
            ],
          ),
